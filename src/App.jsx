      ...
      <Card style={{marginBottom:20}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:12,flexWrap:"wrap",gap:8}}>
          ...
          <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
            {[["revenue","매출"],["mom","전기比"],["aov","객단가"],["share","점유율"],["shipped","배송"],["returned","반품"],["rate","반품률"]].map(([k,l])=>(
        ...
        {(()=>{
          const cols=[
            ...
            {key:"mom",    label:"전기比",  val:c=>{const p=prevChRevenue[c.name]||0;return p>0?(c.revenue-p)/p*100:-Infinity;}},
